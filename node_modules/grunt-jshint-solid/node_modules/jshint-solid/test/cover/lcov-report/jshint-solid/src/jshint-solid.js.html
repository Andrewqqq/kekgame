...
<html lang="en">
<head>
    <title>Code coverage report for jshint-solid/src/jshint-solid.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">jshint-solid/src/jshint-solid.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">jshint-solid/src/</a> &#187; jshint-solid.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var read = require('fs').readFileSync;
...
&nbsp;
  filename = filename || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
  console.log('jshint %s covers %d% of all possible settings',
    filename, quality);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (quality &lt; 75) {
...
function jshintQuality(filename) {
  var jshintFilename = filename || <span class="branch-1 cbranch-no" title="branch not covered" >'./.jshintrc';</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!exists(jshintFilename)) {
<span class="cstat-no" title="statement not covered" >    verify.unemptyString(jshintFilename, 'expected jshint filename');</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Cannot find jshint settings file ' + jshintFilename);</span>
  }
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Sep 08 2014 23:22:36 GMT-0400 (EDT)</div>
</div>
